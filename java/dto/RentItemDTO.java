...
public class RentItemDTO {
    ...
    public RentItemDTO(int item_id, int category_id, int rentalShop_id, String item_name, String item_detail, int total_quantity, String item_img, Date created_at) {
