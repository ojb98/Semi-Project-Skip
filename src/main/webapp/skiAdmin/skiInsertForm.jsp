...
<form id="insertForm" action="${pageContext.request.contextPath }/adminSki/insert" 
	...
	<div class="button-row">
		<input type="text" name="ski_phone" id="phone" placeholder="070-1111-2222"
	...
	<input type="text" name="webcam_url" id="webcam_url"><br>
