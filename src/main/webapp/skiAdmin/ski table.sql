...
INSERT ALL
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1001, 1, 2, TO_DATE('2025-03-15', 'YYYY-MM-DD'), 150000, 'CONFIRMED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1002, 1, 4, TO_DATE('2025-03-16', 'YYYY-MM-DD'), 200000, 'CANCELLED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1003, 1, 4, TO_DATE('2025-03-17', 'YYYY-MM-DD'), 180000, 'COMPLETED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1004, 1, 4, TO_DATE('2025-03-18', 'YYYY-MM-DD'), 170000, 'CONFIRMED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1005, 1, 2, TO_DATE('2025-03-19', 'YYYY-MM-DD'), 220000, 'CONFIRMED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1006, 1, 2, TO_DATE('2025-03-20', 'YYYY-MM-DD'), 195000, 'CANCELLED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1007, 1, 2, TO_DATE('2025-03-21', 'YYYY-MM-DD'), 165000, 'COMPLETED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1008, 1, 2, TO_DATE('2025-03-22', 'YYYY-MM-DD'), 175000, 'CONFIRMED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1009, 1, 2, TO_DATE('2025-03-23', 'YYYY-MM-DD'), 185000, 'COMPLETED', SYSDATE)
  INTO SKI_RESERVATION (SKI_RESERV_ID, SKI_ID, UUID, RESERV_DATE, TOTAL_PRICE, STATUS, CREATED_AT)
    VALUES (1010, 1, 2, TO_DATE('2025-03-24', 'YYYY-MM-DD'), 160000, 'CONFIRMED', SYSDATE)
SELECT * FROM dual;

commit;

-- SKI_PAYMENTS 예제 데이터
INSERT INTO SKI_PAYMENTS (PAYMENT_ID, SKI_RESERV_ID, UUID, TOTAL_PRICE, PAYMENT_METHOD, STATUS, IMP_UID, CARD_NUM, CARD_NAME, CREATED_AT)
VALUES (1, 1002, 2, 150000.00, 'CARD', '결제완료', 'IMP123456789012', '1234-5678-9012-3456', 'KB국민카드', TO_DATE('2025-03-12', 'YYYY-MM-DD'));

INSERT INTO SKI_PAYMENTS (PAYMENT_ID, SKI_RESERV_ID, UUID, TOTAL_PRICE, PAYMENT_METHOD, STATUS, IMP_UID, CARD_NUM, CARD_NAME, CREATED_AT)
VALUES (2, 1003, 2, 200000.00, 'KAKAOPAY', '결제완료', 'IMP987654321098', NULL, NULL, TO_DATE('2025-03-10', 'YYYY-MM-DD'));

INSERT INTO SKI_PAYMENTS (PAYMENT_ID, SKI_RESERV_ID, UUID, TOTAL_PRICE, PAYMENT_METHOD, STATUS, IMP_UID, CARD_NUM, CARD_NAME, CREATED_AT)
VALUES (3, 1004, 2, 120000.00, 'NAVERPAY', '결제취소', 'IMP567890123456', NULL, NULL, TO_DATE('2025-03-08', 'YYYY-MM-DD'));

-- SKI_REVIEWS 예제 데이터
INSERT INTO SKI_REVIEWS (REVIEW_ID, PAYMENT_ID, UUID, SKI_ID, RATING, REVIEW_COMMENT, REVIEW_IMG, CREATED_AT)
VALUES (1, 1, 2, 1, 4.5, '너무 재미있었습니다! 눈 상태도 좋았어요.', 'review_img_1.jpg', TO_DATE('2025-03-12', 'YYYY-MM-DD'));

INSERT INTO SKI_REVIEWS (REVIEW_ID, PAYMENT_ID, UUID, SKI_ID, RATING, REVIEW_COMMENT, REVIEW_IMG, CREATED_AT)
VALUES (2, 2, 2, 1, 3.0, '시설은 좋았는데 사람이 너무 많아서 아쉬웠어요.', 'review_img_2.jpg', TO_DATE('2025-03-10', 'YYYY-MM-DD'));

INSERT INTO SKI_REVIEWS (REVIEW_ID, PAYMENT_ID, UUID, SKI_ID, RATING, REVIEW_COMMENT, REVIEW_IMG, CREATED_AT)
VALUES (3, 3, 2, 1, 5.0, '완벽한 경험이었습니다! 다음에도 또 방문할 예정입니다.', 'review_img_3.jpg', TO_DATE('2025-03-08', 'YYYY-MM-DD'));
