						...
						<ul>
							...
							<c:choose>
								<c:when test="${user.role == 'SKI' }">
									<li><a href="${pageContext.request.contextPath}/skiAdmin/skiSaleManage">관리자사이트</a></li>
								</c:when>
								<c:when test="${user.role == 'RENTAL' }">
									<li><a href="${pageContext.request.contextPath}/rentalAdmin/rentalSaleManage">관리자사이트</a></li>
								</c:when>
								<c:when test="${user.role == 'RESORT' }">
									<li><a href="${pageContext.request.contextPath}/resortAdmin/resortSaleManage">관리자사이트</a></li>
								</c:when>
								<c:when test="${user.role == 'ADMIN' }">
									<li><a href="${pageContext.request.contextPath}/admin/dashboard">관리자사이트</a></li>
								</c:when>
								<c:otherwise>
