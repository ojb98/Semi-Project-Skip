...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css_resort/resortInfo.css">
...
<script>
    ...
    function loadFacilityInfo() {
        ...
        xhr.open("GET", "${pageContext.request.contextPath}/facility/detail?resort_id=" + resortId, true);
    ...
    function loadRoomInfo(page) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "${pageContext.request.contextPath}/room/detail?resort_id=" + resortId + "&page=" + page, true);
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                document.getElementById("dynamicContent").innerHTML = xhr.responseText;
                document.getElementById("dynamicContent").setAttribute("data-resort-id", resortId); // resort_id 저장
...
<div class="button-container-right">
	<a href="${pageContext.request.contextPath }/resort/update?resort_id=${rdto.resort_id}" >
