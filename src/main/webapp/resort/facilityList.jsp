...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css_resort/facilityList.css">
    ...
    <tbody>
        <c:forEach var="dto" items="${flist}">
            ...
            <tr data-type="${dto.type_name}"> 
                ...
                <td>
                    <a href="${pageContext.request.contextPath }/facility/delete?facility_id=${dto.ftypesDto[0].facility_id }"
