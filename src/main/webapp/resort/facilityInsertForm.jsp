...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css_resort/facilityInsert.css">
...
<body>
	...
	<form id="facilityForm" action="${pageContext.request.contextPath }/facility/insert" method="post" onsubmit="return checkData(event)">
	...
	<button class="main-btn" onclick="window.location.href='${pageContext.request.contextPath}/index.jsp'">메인으로 가기</button>
