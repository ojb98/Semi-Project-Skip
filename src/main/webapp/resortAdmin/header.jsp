...
<header>
    <div class="header-left">
        <a href="${pageContext.request.contextPath}/resortAdmin/resortSaleManage.jsp">
            <h1>SKI:P</h1>
        </a>
    </div>
    <!-- 우측 정보는 삭제 -->
...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/resortAdmin/resortSaleManage.jsp">통계</a></li>
    </ul>
</aside> 