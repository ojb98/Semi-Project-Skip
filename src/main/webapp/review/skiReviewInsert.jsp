...
<body>
	<form id="reviewForm" method="post" action="${pageContext.request.contextPath}/review/skiReviewInsert" enctype="multipart/form-data" onsubmit="setTimeout(closePopup, 500)">
		<h2>리뷰작성</h2>
		<div class = "">
			<lable>스키장 결제 아이디</lable>
		...
		<div class="">
			<lable>스키장 아이디</lable>
			<input type="text" name="ski_id" value="${ski_id }">
		</div>
		<div class="">
			<label>리뷰 평점</label>
		...
		<div class="">
			<label>리뷰내용</label>
			<textarea id="skiComment" rows="5" cols="50" name="ski_comment" placeholder="5자 이상입력하세요."></textarea>
