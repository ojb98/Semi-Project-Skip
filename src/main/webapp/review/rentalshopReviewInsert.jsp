...
<body>
	<form id="reviewForm" class="insert_form" method="post" action="${pageContext.request.contextPath}/review/rentalshopReviewInsert" enctype="multipart/form-data" onsubmit="setTimeout(closePopup, 500)">
		<h2>리뷰작성</h2>
		<div class = "">
		...
		<div class="">
			<input type="hidden" name="rentalshop_id" value="${rentalshop_id }" readonly>
		</div>
