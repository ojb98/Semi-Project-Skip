...
<body>
	<form id="reviewForm" method="post" action="${pageContext.request.contextPath}/review/rentalshopReviewInsert" enctype="multipart/form-data" onsubmit="setTimeout(closePopup, 500)">
		<h2>리뷰작성</h2>
		<div class = "">
		...
		<div class="">
			<label>리뷰내용</label>
			<textarea id="rentalshopComment" rows="5" cols="50" name="rentalshop_comment" placeholder="5자 이상입력하세요."></textarea>
	...
	reviewForm.addEventListener("submit", (event) => {
	    ...
	    // 리뷰 내용 유효성 검사
	    const reviewText = document.querySelector("#rentalshopComment").value.trim();
