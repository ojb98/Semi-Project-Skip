  ...
  <c:forEach var="list" items="${list}">
    <c:forEach var="it" items="${list.itemesDto}">
      <tr>
         ...
         <td>${it.created_at}</td>
         <td>
           <a href="${pageContext.request.contextPath}/adminItemCategory/update?item_id=${it.item_id}">
             <button class="update-btn">수정</button>
           </a>
         </td>
         <td>
           <a href="${pageContext.request.contextPath}/adminItem/delete?item_id=${it.item_id}" onclick="return confirm('정말 삭제하시겠습니까?');">
