...
(
    ...
    RENTAL_PHONE  VARCHAR2(50) 		   NOT NULL,
...
(
    ...
    STATUS         VARCHAR2(20) 		DEFAULT '결제완료' NOT NULL CHECK (STATUS IN ('결제완료', '결제취소')),
...
-- INSERT
INSERT INTO RENT_PAYMENTS VALUES (1, 1, 1, 50000, 'CARD', '결제완료', 'IMP_1234567890', '1234-5678-9012-3456', 'KB국민카드', SYSDATE);
INSERT INTO RENT_PAYMENTS VALUES (2, 2, 2, 75000, 'KAKAOPAY', '결제완료', 'IMP_0987654321', '1234-5678-9012-3456', '우리카드', SYSDATE);
INSERT INTO RENT_PAYMENTS VALUES (3, 3, 3, 120000, 'NAVERPAY', '결제완료', 'IMP_5678901234', '1234-5678-9012-3456', '삼성카드', SYSDATE);
INSERT INTO RENT_PAYMENTS VALUES (4, 4, 4, 65000, 'CARD', '결제취소', 'IMP_3456789012', '9876-5432-1098-7654', '신한카드', SYSDATE);
INSERT INTO RENT_PAYMENTS VALUES (5, 5, 5, 89000, 'KAKAOPAY', '결제취소', 'IMP_6789012345', '1234-5678-9012-3456', '현대카드', SYSDATE);


-- 시퀀스
CREATE SEQUENCE RENTALSHOP_SEQ START WITH 200;
CREATE SEQUENCE RENTAL_RESERVATION_SEQ START WITH 200;
CREATE SEQUENCE RENT_RESERVATION_ITEM_SEQ START WITH 200;
CREATE SEQUENCE ITEM_CATEGORY_SEQ START WITH 200;
CREATE SEQUENCE RENT_ITEM_SEQ START WITH 200;
CREATE SEQUENCE RENT_PAYMENTS_SEQ START WITH 200;
