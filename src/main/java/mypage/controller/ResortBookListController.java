...
import resort.dao.ResortReservationDao;
import resort.dto.ResortReservationListDto;
import users.dto.UsersDto;
import util.PageUtil;

@WebServlet("/mypage/bookings/resort")
public class ResortBookListController extends HttpServlet {
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ResortReservationDao dao = ResortReservationDao.getInstance();
		...
		List<ResortReservationListDto> list = dao.selectByUuid(map);
