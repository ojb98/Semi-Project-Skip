...
@WebServlet("/resortAdmin/reservationList")
public class ResortReservationController extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ResortReservationPrintDto> reservationList;
        try (SqlSession sqlSession = SqlSessionFactoryService.getSqlSessionFactory().openSession()) {
            ...
            updateParams.put("resortID", resortID);
            ...
            // 업데이트된 리스트 다시 조회
            reservationList = mapper.selectReservationByResortId(params);
        }
        
        req.setAttribute("reservationList", reservationList);
        req.getRequestDispatcher("/resortAdmin/reservationList.jsp").forward(req, resp);
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    response.sendRedirect("/resortAdmin/resortReservation.jsp");
	}
