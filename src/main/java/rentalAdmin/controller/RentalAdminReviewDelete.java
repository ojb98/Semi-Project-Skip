...
@WebServlet("/rentalshopAdmin/reviewDelete")
public class RentalAdminReviewDelete extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect(req.getContextPath() + "/rentalshopAdmin/rentalshopAdminReview");
