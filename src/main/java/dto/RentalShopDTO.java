...
public class RentalShopDTO {
    ...
    public RentalShopDTO(int rentalshop_id, int uuid, String name, String location, String resub_img1, String resub_img2, String resub_img3, String description, Date created_at) {
