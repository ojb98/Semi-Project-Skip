...
public class RentalShopListDTO {
	...
	public RentalShopListDTO() {}

	public RentalShopListDTO(int rentalshop_id, String user_id, String name, String rental_phone, String location,
	...
	public String toString() {
		return "RentalShopListDTO [rentalshop_id=" + rentalshop_id + ", user_id=" + user_id + ", name=" + name
				+ ", rental_phone=" + rental_phone + ", location=" + location + ", remain_img=" + remain_img
				+ ", resub_img1=" + resub_img1 + ", resub_img2=" + resub_img2 + ", resub_img3=" + resub_img3
