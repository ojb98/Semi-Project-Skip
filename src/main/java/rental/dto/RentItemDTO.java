...
public class RentItemDTO {
	...
	public RentItemDTO(int item_id, int category_id, int rentalshop_id, String item_name, String item_detail,
	...
	public String toString() {
		return "RentItemDTO [item_id=" + item_id + ", category_id=" + category_id + ", rentalshop_id=" + rentalshop_id
