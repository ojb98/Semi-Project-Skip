...
public class SkiListDTO {
	...
	public SkiListDTO(int ski_id, String user_id, String name, String ski_phone, String location, String webcam_url,
	...
	public String toString() {
		return "SkiListDTO [ski_id=" + ski_id + ", user_id=" + user_id + ", name=" + name + ", ski_phone=" + ski_phone
