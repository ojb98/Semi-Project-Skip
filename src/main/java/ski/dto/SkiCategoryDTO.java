...
public class SkiCategoryDTO {
    ...
    public SkiCategoryDTO(String item_detail, int total_quantity, int item_id, int category_id, int ski_id, String item_name, String item_img, String item_type, String price_per_hour) {
